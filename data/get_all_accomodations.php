...
//with ana nga date
$sqlBookedSit = "SELECT COUNT(book_id) as sit 
				 FROM booked 
				 WHERE acc_id = ?
				 AND book_departure = ? 
";
...
$sqlBookedEcoA = "SELECT COUNT(book_id) as ecoA
				 FROM booked 
				 WHERE acc_id = ?
				 AND book_departure = ?; 
	";
...
$sqlBookedEcoB = "SELECT COUNT(book_id) as ecoB
				 FROM booked 
				 WHERE acc_id = ?
				 AND book_departure = ?; 
	";
...
$sqlBookedTour = "SELECT COUNT(book_id) as ecoT
				 FROM booked 
				 WHERE acc_id = ?
				 AND book_departure = ?; 
	";
...
$sqlBookedCab = "SELECT COUNT(book_id) as ecoC
				 FROM booked 
				 WHERE acc_id = ?
				 AND book_departure = ?; 
	";
