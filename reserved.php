	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php">Online Ticketing</a>
			</div>
...
<!-- //////////////////////////////////////////////////////////////////////////// -->
								...
								<!-- <?php
								$sql = "SELECT  origin_desc FROM origin;";
									$qry = mysqli_query($conn, $sql) or die ("wrong ");
									$count = mysqli_num_rows($qry);

									if($count!=0){
										while($result = mysqli_fetch_all($qry)){
											$result['origin_desc'];
										}
									}
				...
				$.ajax({
					...
					success: function(data) {
						...
						// if (data.valid == true) {
							...
							window.location = "accomodation.php";
						// 	console.log('sss');
						// }
					},
					error: function() {
